...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-avocado-600">
      <form onSubmit={handleLogin} className="p-6 bg-white rounded shadow-md w-80">
        ...
        <button type="submit" className="w-full text-black p-2 rounded border-2 !bg-blue-300">Login</button>
        </form>
    </div>
  );
};
